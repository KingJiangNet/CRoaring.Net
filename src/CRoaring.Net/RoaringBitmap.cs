...
namespace CRoaring
{
    public class RoaringBitmap : IDisposable, IEnumerable<uint>
    {
        ...
        public RoaringBitmap(IntPtr pointer)
        {
            _pointer = pointer;
        }
        ...
        {
            get { return NativeMethods.roaring_bitmap_get_cardinality(_pointer); }
        }

        public bool IsEmpty
        {
            get { return NativeMethods.roaring_bitmap_is_empty(_pointer); }
        }

        public IntPtr UnsafePinter
        {
            get { return _pointer; }
        }

        //public int SerializedBytes {  return  NativeMethods.roaring_bitmap_size_in_bytes(_pointer);} 

        //public int PortableSerializedBytes {  return  NativeMethods.roaring_bitmap_portable_size_in_bytes(_pointer);} 

        public static RoaringBitmap FromRange(uint min, uint max, uint step = 1)
        { 
            return new RoaringBitmap(NativeMethods.roaring_bitmap_from_range(min, max, step));
        }

        public static RoaringBitmap FromValues(uint[] values)
        { 
            return new RoaringBitmap(NativeMethods.roaring_bitmap_of_ptr((uint)values.Length, values)); 
        }        
        ...
        {
            return NativeMethods.roaring_bitmap_contains(_pointer, value); 
        }
        ...
        { 
            return NativeMethods.roaring_bitmap_select(_pointer, rank, out element);
        }

        public RoaringBitmap Not(ulong start, ulong end)
        { 
            return new RoaringBitmap(NativeMethods.roaring_bitmap_flip(_pointer, start, end)); 
        }
        ...
        {
            return new RoaringBitmap(NativeMethods.roaring_bitmap_and(_pointer, bitmap._pointer));
        }
        ...
        { 
            return new RoaringBitmap(NativeMethods.roaring_bitmap_andnot(_pointer, bitmap._pointer));
        }
        ...
        { 
            return new RoaringBitmap(NativeMethods.roaring_bitmap_or(_pointer, bitmap._pointer));
        }
        ...
        {
            return new RoaringBitmap(NativeMethods.roaring_bitmap_xor(_pointer, bitmap._pointer));
        }
        ...
        { 
            return new RoaringBitmap(NativeMethods.roaring_bitmap_lazy_or(_pointer, bitmap._pointer, bitsetConversion)); 
        }
        ...
        { 
            return new RoaringBitmap(NativeMethods.roaring_bitmap_lazy_xor(_pointer, bitmap._pointer, bitsetConversion));
        }
        ...
        {
            return NativeMethods.roaring_bitmap_run_optimize(_pointer); 
        }

        public bool RemoveRunCompression()
        { 
            return NativeMethods.roaring_bitmap_remove_run_compression(_pointer);
        }
        ...
        /*public void Print()
            {  return  NativeMethods.roaring_bitmap_printf(_pointer); } */
        ...
        public IEnumerator<uint> GetEnumerator()
        {
            ...
            new Task(() =>
            {
                try
                {
                    NativeMethods.roaring_iterate(_pointer, enumerator.AddValue, IntPtr.Zero);
                }
                finally
                {
                    enumerator.Complete();
