 ...
 */
EXPORT roaring_bitmap_t *roaring_bitmap_create(void);

/**
 * Add all the values between min (included) and max (excluded) that are at a
 * distance k*step from min.
*/
EXPORT roaring_bitmap_t *roaring_bitmap_from_range(uint32_t min, uint32_t max,
                                            uint32_t step);
 ...
 */
EXPORT roaring_bitmap_t *roaring_bitmap_create_with_capacity(uint32_t cap);

/**
 * Creates a new bitmap from a pointer of uint32_t integers
 */
EXPORT roaring_bitmap_t *roaring_bitmap_of_ptr(size_t n_args, const uint32_t *vals);

/**
 * Describe the inner structure of the bitmap.
 */
EXPORT void roaring_bitmap_printf_describe(const roaring_bitmap_t *ra);

/**
 * Creates a new bitmap from a list of uint32_t integers
 */
EXPORT roaring_bitmap_t *roaring_bitmap_of(size_t n, ...);
 ...
 *
 */
EXPORT roaring_bitmap_t *roaring_bitmap_copy(const roaring_bitmap_t *r);

/**
 * Print the content of the bitmap.
 */
EXPORT void roaring_bitmap_printf(const roaring_bitmap_t *ra);
 ...
 *
 */
EXPORT roaring_bitmap_t *roaring_bitmap_and(const roaring_bitmap_t *x1,
                                     const roaring_bitmap_t *x2);

/**
 * Inplace version modifies x1, x1 == x2 is allowed
 */
EXPORT void roaring_bitmap_and_inplace(roaring_bitmap_t *x1,
                                const roaring_bitmap_t *x2);
 ...
 * responsible for memory management.
 */
EXPORT roaring_bitmap_t *roaring_bitmap_or(const roaring_bitmap_t *x1,
                                    const roaring_bitmap_t *x2);
 ...
 *
 */
EXPORT void roaring_bitmap_or_inplace(roaring_bitmap_t *x1,
                               const roaring_bitmap_t *x2);
 ...
 *
 */
EXPORT roaring_bitmap_t *roaring_bitmap_or_many(size_t number,
 ...
 *
 */
EXPORT roaring_bitmap_t *roaring_bitmap_or_many_heap(uint32_t number,
                                              const roaring_bitmap_t **x);
 ...
 */
EXPORT roaring_bitmap_t *roaring_bitmap_xor(const roaring_bitmap_t *x1,
                                     const roaring_bitmap_t *x2);
 ...
 *
 */
EXPORT void roaring_bitmap_xor_inplace(roaring_bitmap_t *x1,
                                const roaring_bitmap_t *x2);
 ...
 *
 */
EXPORT roaring_bitmap_t *roaring_bitmap_xor_many(size_t number,
                                          const roaring_bitmap_t **x);
 ...
 * and returns new bitmap. The caller is responsible for memory management.
 */
EXPORT roaring_bitmap_t *roaring_bitmap_andnot(const roaring_bitmap_t *x1,
                                        const roaring_bitmap_t *x2);
 ...
 *
 */
EXPORT void roaring_bitmap_andnot_inplace(roaring_bitmap_t *x1,
                                   const roaring_bitmap_t *x2);
 ...
 * Frees the memory.
 */
EXPORT void roaring_bitmap_free(roaring_bitmap_t *r);

/**
 * Add value n_args from pointer vals, faster than repeatedly calling roaring_bitmap_add
 *
 */
EXPORT void roaring_bitmap_add_many(roaring_bitmap_t * r, size_t n_args, const uint32_t *vals);

/**
 * Add value x
 *
 */
EXPORT void roaring_bitmap_add(roaring_bitmap_t *r, uint32_t x);

/**
 * Remove value x
 *
 */
EXPORT void roaring_bitmap_remove(roaring_bitmap_t *r, uint32_t x);

/**
 * Check if value x is present
 */
EXPORT inline bool roaring_bitmap_contains(const roaring_bitmap_t *r,
                                           uint32_t val) {
 ...
 */
EXPORT uint64_t roaring_bitmap_get_cardinality(const roaring_bitmap_t *ra);

/**
* Returns true if the bitmap is empty (cardinality is zero).
*/
EXPORT bool roaring_bitmap_is_empty(const roaring_bitmap_t *ra);
 ...
 *   * sizeof(uint32_t))
 */
EXPORT void roaring_bitmap_to_uint32_array(const roaring_bitmap_t *ra, uint32_t *ans);

/**
 *  Remove run-length encoding even when it is more space efficient
 *  return whether a change was applied
 */
EXPORT bool roaring_bitmap_remove_run_compression(roaring_bitmap_t *r);
 ...
 */
EXPORT bool roaring_bitmap_run_optimize(roaring_bitmap_t *r);

/**
 * If needed, reallocate memory to shrink the memory usage. Returns
 * the number of bytes saved.
*/
EXPORT size_t roaring_bitmap_shrink_to_fit(roaring_bitmap_t *r);
...
*/
EXPORT size_t roaring_bitmap_serialize(const roaring_bitmap_t *ra, char *buf);

/**  use with roaring_bitmap_serialize
* see roaring_bitmap_portable_deserialize if you want a format that's
* compatible with Java and Go implementations
*/
EXPORT roaring_bitmap_t *roaring_bitmap_deserialize(const void *buf);
 ...
 * with Java and Go versions)
 */
EXPORT size_t roaring_bitmap_size_in_bytes(const roaring_bitmap_t *ra);
 ...
 */
EXPORT roaring_bitmap_t *roaring_bitmap_portable_deserialize(const char *buf);
 ...
 */
EXPORT size_t roaring_bitmap_portable_size_in_bytes(const roaring_bitmap_t *ra);
 ...
 */
EXPORT size_t roaring_bitmap_portable_serialize(const roaring_bitmap_t *ra, char *buf);
 ...
 */
EXPORT bool roaring_iterate(const roaring_bitmap_t *ra, roaring_iterator iterator,
                     void *ptr);

EXPORT bool roaring_iterate64(const roaring_bitmap_t *ra, roaring_iterator64 iterator,
                       uint64_t high_bits, void *ptr);

/**
 * Return true if the two bitmaps contain the same elements.
 */
EXPORT bool roaring_bitmap_equals(const roaring_bitmap_t *ra1, const roaring_bitmap_t *ra2);

/**
 * Return true if all the elements of ra1 are also in ra2.
 */
EXPORT bool roaring_bitmap_is_subset(const roaring_bitmap_t *ra1, const roaring_bitmap_t *ra2);

/**
 * Return true if all the elements of ra1 are also in ra2 and ra2 is strictly greater
 * than ra1.
 */
EXPORT inline bool roaring_bitmap_is_strict_subset(const roaring_bitmap_t *ra1, const roaring_bitmap_t *ra2) {
 ...
 **/
EXPORT roaring_bitmap_t *roaring_bitmap_lazy_or(const roaring_bitmap_t *x1,
                                         const roaring_bitmap_t *x2,
 ...
 * whether container-container operations force a bitset conversion.
 */
EXPORT void roaring_bitmap_lazy_or_inplace(roaring_bitmap_t *x1,
                                    const roaring_bitmap_t *x2,
                                    const bool bitsetconversion);
 ...
 */
EXPORT void roaring_bitmap_repair_after_lazy(roaring_bitmap_t *x1);
 ...
 *
 */
EXPORT roaring_bitmap_t *roaring_bitmap_lazy_xor(const roaring_bitmap_t *x1,
                                          const roaring_bitmap_t *x2);
 ...
 *
 */
EXPORT void roaring_bitmap_lazy_xor_inplace(roaring_bitmap_t *x1,
                                     const roaring_bitmap_t *x2);
...
EXPORT roaring_bitmap_t *roaring_bitmap_flip(const roaring_bitmap_t *x1,
...
EXPORT void roaring_bitmap_flip_inplace(roaring_bitmap_t *x1, uint64_t range_start,
                                 uint64_t range_end);
 ...
 */
EXPORT bool roaring_bitmap_select(const roaring_bitmap_t *ra, uint32_t rank,
                           uint32_t *element);
/**
* roaring_bitmap_rank returns the number of integers that are smaller or equal to x.
*/
EXPORT uint64_t  roaring_bitmap_rank(const roaring_bitmap_t *bm, uint32_t x);
...
*/
EXPORT uint32_t roaring_bitmap_minimum(const roaring_bitmap_t *bm);
...
*/
EXPORT uint32_t roaring_bitmap_maximum(const roaring_bitmap_t *bm);
...
*/
EXPORT void roaring_bitmap_statistics(const roaring_bitmap_t *ra,
...
* in increasing order.
*/
EXPORT void roaring_init_iterator(const roaring_bitmap_t *ra, roaring_uint32_iterator_t * newit);
...
*/
EXPORT roaring_uint32_iterator_t * roaring_create_iterator(const roaring_bitmap_t *ra);
...
*/
EXPORT bool roaring_advance_uint32_iterator(roaring_uint32_iterator_t *it);

/**
* Creates a copy of an iterator.
* Caller must free it.
*/
EXPORT roaring_uint32_iterator_t * roaring_copy_uint32_iterator(const roaring_uint32_iterator_t * it);

/**
* Free memory following roaring_create_iterator
*/
EXPORT void roaring_free_uint32_iterator(roaring_uint32_iterator_t *it);
